...
Part of the [Render](../render.md) skill, under Aesthetic Vocabularies. See the top-level index for mission and universal rules that apply across every vocabulary.
