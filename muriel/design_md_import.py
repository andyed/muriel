...
def _emit_toml(data: dict[str, Any], header: Optional[str] = None) -> str:
    ...
    ``header`` overrides the leading comment block (e.g. for a different
    importer). Defaults to the design.md provenance note.
    """
    lines: list[str] = []
    lines.append(_DEFAULT_TOML_HEADER if header is None else header)
