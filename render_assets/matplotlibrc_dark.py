"""
render_assets.matplotlibrc_dark — OLED dark palette for matplotlib.

Drop-in matplotlib configuration matching Render's universal rules:
...
Auto-apply on import (side-effect — affects global rcParams):
    ...
    from render_assets import matplotlibrc_dark   # noqa: F401

Manual control:

    from render_assets.matplotlibrc_dark import apply, PARAMS
...
See `channels/science.md` in the render repo for the rationale behind
each setting.
"""
...
PARAMS: dict = {
    ...
    # ── palette (cream on near-black; matches Render universal OLED) ──
...
# Auto-apply on bare `import render_assets.matplotlibrc_dark`.
