"""
render_assets.matplotlibrc_light — warm editorial light palette for matplotlib.
...
clinical journal-white look. Palette matches the Attentional Foraging
F-pattern explainer at:

    ~/Documents/dev/attentional-foraging/site/explainer/index.html
...
Font stack is Georgia serif by default — matches the F explainer's
reading-edition voice. Override to sans-serif if the target is a blog
with a sans body:
...
Auto-apply on import:
    ...
    from render_assets import matplotlibrc_light   # noqa: F401

Scoped:

    import matplotlib.pyplot as plt
    from render_assets.matplotlibrc_light import PARAMS
