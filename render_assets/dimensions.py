"""
render_assets.dimensions — common screen-size footprints as importable constants.

Code-side companion to ``channels/dimensions.md`` in the render repo.
...
import the constants by name for common idioms::
    ...
    from render_assets.dimensions import TWITTER_INSTREAM, OG_CARD, VIDEO_1080P
...
def _main() -> int:
    ...
    print("\n── render_assets.dimensions — registry ──")
