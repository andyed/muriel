...
- [`channels/web.md`](web.md) covers editorial HTML, Marginalia, Pandoc, and static capture — the *prose* surface.
- [`channels/interactive.md`](interactive.md) covers live demos where the reader moves parameters — the *exploratory* surface.
...
If the work is data viz, use [`channels/charts.md`](charts.md). If it's a live demo, use [`channels/interactive.md`](interactive.md). If it's prose-rendering HTML, use [`channels/web.md`](web.md).
...
- [`channels/web.md`](web.md) — editorial HTML, marginalia, the prose surface where polish rules apply to readable content
- [`channels/interactive.md`](interactive.md) — live demos with parameter sliders, where the polish rules apply to the controls
- [`channels/charts.md`](charts.md) — data viz, where polish applies to tooltips, axis labels, hover states
